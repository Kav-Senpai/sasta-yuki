...
class Admin(commands.Cog):
    ...
    async def on_message_delete(self, message):
        # Remove poll
        with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\poll.json', 'r') as file:
            poll_data = json.load(file)

        # Remove schedule
        with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\scheduler.json', 'r') as file:
            scheduler_data = json.load(file)

        if str(message.id) in poll_data:
            poll_data.pop(str(message.id))

            with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\poll.json', 'w') as update_poll_data:
                json.dump(poll_data, update_poll_data, indent=4)

            scheduler_data.pop(str(message.channel.id))

            with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\scheduler.json', 'w') as update_scheduler_data:
    ...
    async def poll(self, ctx, time: int, vote: int, title, *options):
        if len(options) > 10:
            ...
            with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\scheduler.json', 'r') as scheduler_file:
                ...
                if str(ctx.message.channel.id) not in scheduler_data:
                    ...
                    # Poll data
                    with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\poll.json', 'r') as poll_file:
                        ...
                        with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\poll.json', 'w') as new_poll_data:
                    ...
                    with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\scheduler.json', 'w') as new_scheduler_data:
        ...
        if payload.member.id != self.client.user.id:
            ...
            with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\poll.json', 'r') as poll_file:
                ...
                if str(payload.message_id) in poll_data:
                    ...
                    with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\scheduler.json', 'r') as schedule:
    ...
    async def poll_result(self):
        with open('C:\\Users\\Naveen Bagotra\\Desktop\\VSCode\\Yuki\\databases\\scheduler.json', 'r') as schedule_file:
